...
gulp.task('css', async function(){
	return gulp.src('app/js/script/slick-slider/_slick-slider.scss')
...
gulp.task ('js', function (){
	return gulp.src(['app/js/script/slick-slider/slick.js', 'app/js/script/ScrollMagic/ScrollMagic.js'])
